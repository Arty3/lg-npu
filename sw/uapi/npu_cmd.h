...
#define NPU_CMD_WORDS (NPU_CMD_ENTRY_BYTES / sizeof(uint32_t))
...
struct npu_cmd_desc
{
    uint32_t words[NPU_CMD_WORDS];
};

STATIC_ASSERT(sizeof(struct npu_cmd_desc) == NPU_CMD_ENTRY_BYTES,
